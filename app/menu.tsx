...
export default function Menu() {
	...
	return (
		<>
			...
			<div
				className={` absolute left-0 top-20 z-50 w-96 max-w-full h-[calc(100vh-80px)] px-8 bg-backgroundSecondary border-r border-gray-200 transition-transform ease duration-300 ${
